          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <p className="text-muted-foreground leading-relaxed">
                Founded in 2023, DAKXINPATH® has grown from a small family business to one of the leading agricultural export companies, serving over 10+ countries worldwide. Our commitment to quality, sustainability, and customer satisfaction has made us a trusted partner for businesses across the globe.
              </p>
